const en = {
  ...
  onboarding: {
    ...
    intro: "Select how you would like to explore NOX Studio.",
  ...
  meta: { title: "NOX Studio - Digital Agency", description: "Websites, products, and brands built to be remembered." },
} as const;
